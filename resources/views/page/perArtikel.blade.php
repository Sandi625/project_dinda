    ...
    <nav class="navbar navbar-expand-lg navbar-light navbarKu fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand" href="#">
                <img src="../images/logo.png" alt="Logo SMK N Srono">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
            ...
            <a class="dropdown-item" href="{{ route('kontak.page') }}">Contact Us</a>
                ...
                <form class="form-inline my-2 my-lg-0">
                    ...
                    <button class="btn btn-primary btnCari sm-0" type="submit">
    ...
    <div class="container mainDetailArtikel">
        <div class="row">
            <div class="col-md-8">
                ...
                <h4>2. Melakukan Konfigurasi Database</h4>
                ...
                <h4>3. Menghubungkan Laravel dengan Bootstrap</h4>
            ...
            <div class="col-md-4 infoPenulis ">
                <div class="">
                    ...
                    <div class="penulis">
                        ...
                        <img src="images/darimun.jpeg" alt="Img Penulis">
                        <h4>Dinda</h4>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="footerContactUs">
                        ...
                        <div class="perFooterContactUs">
                            ...
                            <p class="text-white">official@smkn2srono.com</p>
                        </div>
                        ...
                        <div class="perFooterContactUs">
                            ...
                            <p class="text-white">Jl. Raya Banyuwangi</p>
                        </div>

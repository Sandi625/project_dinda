...
<head>
    ...
    <title>Ekstrakulikuler SMK Srono</title>
...
<body>
    ...
    <div class="title">
        ...
        <p class="text-center">Beberapa Ekstrakulikuler Yang Dimiliki SMK N Srono</p>
    </div>

    <div class="container ekstrakulikuler">
        <a href="perEkstrakulikuler.html" class="perEkstrakulikuler">
            <p>Sepak Bola</p>
        </a>

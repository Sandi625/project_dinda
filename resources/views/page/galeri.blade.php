...
<body>
    <nav class="navbar navbar-expand-lg navbar-light navbarKu fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand" href="#">
                <img src="../images/logo.png" alt="Logo SMK Srono">
                <h1>SMK Negeri<br>Srono</h1>
            </a>
    ...
    <li class="nav-item {{ request()->is('artikel') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('artikel.page') }}">Artikel</a>
    </li>

    <li class="nav-item dropdown {{ request()->is('ekstrakulikuler') || request()->is('kontak') ? 'active' : '' }}">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
            <a class="dropdown-item" href="{{ route('ekstrakulikuler.page') }}">Ekstrakulikuler</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="{{ route('kontak.page') }}">Contact Us</a>
        </div>
    </li>
</ul>
    ...
    <div class="container">
        <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <td><img width="100" height="50" src="images/5e72f68fbd34a-excellent-desktop2.jpg" alt=""></td>
                    <td>Pramuka</td>
                    <td><a href="" class="btn btn-primary">Selengkapnya</a></td>
                </tr>

                <tr>
                    <td><img width="100" height="50" src="images/5e72f6adbf417-commitment2-desktop.jpg" alt=""></td>
                    <td>Pramuka</td>
                    <td><a href="" class="btn btn-primary">Selengkapnya</a></td>
                </tr>

                <tr>
                    <td><img width="100" height="50" src="images/5e72f7134ca67-integrity-desktop2.jpg" alt=""></td>
                    <td>Pramuka</td>
                    <td><a href="" class="btn btn-primary">Selengkapnya</a></td>
                </tr>

                <tr>
                    <td><img width="100" height="50" src="images/5e72f72cca561-respect-desktop2.jpg" alt=""></td>
                    <td>Pramuka</td>
                    <td><a href="" class="btn btn-primary">Selengkapnya</a></td>
                </tr>
                ...
                <tr>
                    <td><img width="100" height="50" src="images/5e72f74b99ff0-humility-desktop2.jpg" alt=""></td>
                    <td>Pramuka</td>
                    <td><a href="" class="btn btn-primary">Selengkapnya</a></td>
                </tr>
            </tbody>
                ...
                <div class="col-md-4">
                    ...
                    <div class="footerContactUs">
                        ...
                        <div class="perFooterContactUs">
                            ...
                            <p class="text-white">official@smknsrono.com</p>
                        </div>
                        ...
                        <div class="perFooterContactUs">
                            ...
                            <p class="text-white">Jl. Raya Srono</p>
                        </div>
    ...
    <div class="footerCopyright">
        <p class="text-white">
            <i class="far fa-copyright"></i>2025<span>Dinda</span>
        </p>
    </div>
</body>

...
<body>
    ...
    <div class="sambutan">
        <h1>WELCOME TO Smk Srono</h1>
        <p>
            SMKN Srono merupakan sekolah terbagus dan terluas yang ada di Banyuwangi<br>
    ...
    <div class="kepsek">
        <div class="container">
            <img src="images/darimun.jpeg" alt="Kepala SMK N srono">
    ...
    <div class="footerCopyright">
        <p class="text-white">
            <i class="far fa-copyright"></i>2025 By : <span>Dinda</span>
        </p>
    </div>
